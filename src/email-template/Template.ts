...
export const sendPayemntLinkTemplate = ({
  amount,
  duration,
  paymentLink,
  userName,
}: PaymentDetails) => `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
export const rejectedTemplete = () => `<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
export const sendRenewLinkTemplate = ({
  amount,
  duration,
  paymentLink,
  userName,
...
export const sendIdPassword = ({ username, password }: UsernamePassword) => `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
`;
export const renewSuccess = ({ username, password }: UsernamePassword) => `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
export const sendSubmitionSuccess = ({
  username,
}: {
  username: string;
}) => `<!DOCTYPE html>
...
export const forgotpasswordTemplete = ({
  url,
}: {
  url?: string;
}) => `<!DOCTYPE html>
...
export const requestForFreeApproved = ({
  link,
  username,
}: {
  link?: String;
